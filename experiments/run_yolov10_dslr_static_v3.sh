#!/usr/bin/env bash
# PCB-DSLR target domain (v3) — yolov10 static (static conf=0.25), Gen0->Gen3
...
LOG="experiments/run_yolov10_dslr_static_v3.log"
...
echo "=== yolov10 PCB-DSLR static self-training (v3) ===" | tee "$LOG"
