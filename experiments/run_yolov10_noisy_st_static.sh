#!/usr/bin/env bash
# Noise experiment — YOLOv10 static threshold (conf=0.25, seed=42)
...
OUTPUT="experiments/yolov10_st_noisy_static_42"
LOG="experiments/run_yolov10_noisy_st_static.log"
...
echo "=== YOLOv10 noise experiment — static self-training ===" | tee "$LOG"
