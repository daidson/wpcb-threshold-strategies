#!/usr/bin/env bash
# PCB-DSLR target domain (v3) — yolo12 adaptive (adaptive precision-target on DEV), Gen0->Gen3
...
OUTPUT="experiments/yolo12_st_dslr_adaptive_v3_42"
LOG="experiments/run_yolo12_dslr_adaptive_v3.log"
...
echo "=== yolo12 PCB-DSLR adaptive self-training (v3) ===" | tee "$LOG"
