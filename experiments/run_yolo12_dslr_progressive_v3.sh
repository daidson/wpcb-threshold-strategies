#!/usr/bin/env bash
# PCB-DSLR target domain (v3) — yolo12 progressive (progressive 0.25->0.35->0.45), Gen0->Gen3
...
MODEL="yolo12"
CONFIG="configs/yolo12/self_train_dslr_progressive.yaml"
OUTPUT="experiments/yolo12_st_dslr_progressive_v3_42"
LOG="experiments/run_yolo12_dslr_progressive_v3.log"
...
echo "=== yolo12 PCB-DSLR progressive self-training (v3) ===" | tee "$LOG"
