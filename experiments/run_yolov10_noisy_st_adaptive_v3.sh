#!/usr/bin/env bash
# YOLOv10 noisy adaptive self-training — v3 (corrected Gen0 teacher)
...
OUTPUT="experiments/yolov10_st_noisy_adaptive_v3_42"
LOG="experiments/run_yolov10_noisy_st_adaptive_v3.log"
LABELED_IMAGES="data/FICS_PCB_REMAP_NOISE_TRAIN/images"
LABELED_LABELS="data/FICS_PCB_REMAP_NOISE_TRAIN/labels"

echo "=== YOLOv10 noisy adaptive self-training (v3) ===" | tee "$LOG"
