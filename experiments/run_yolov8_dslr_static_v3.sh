#!/usr/bin/env bash
# PCB-DSLR target domain (v3) — yolov8 static (static conf=0.25), Gen0->Gen3
...
OUTPUT="experiments/yolov8_st_dslr_static_v3_42"
LOG="experiments/run_yolov8_dslr_static_v3.log"
...
echo "=== yolov8 PCB-DSLR static self-training (v3) ===" | tee "$LOG"
