#!/usr/bin/env bash
# PCB-DSLR target domain (v3) — yolo12 PATH A static (static conf=0.25), Gen0->Gen3
...
OUTPUT="experiments/yolo12_st_dslr_pathA_static_v3_42"
LOG="experiments/run_yolo12_dslr_pathA_static_v3.log"
LABELED_IMAGES="data/FICS_PCB_REMAP_NOISE_TRAIN/images"
LABELED_LABELS="data/FICS_PCB_REMAP_NOISE_TRAIN/labels"

echo "=== yolo12 PCB-DSLR PATH A static self-training (v3) ===" | tee "$LOG"
...
echo "--- self-training loop (static conf=0.25, support base retained) ---" | tee -a "$LOG"
