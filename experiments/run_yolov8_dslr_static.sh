#!/usr/bin/env bash
# PCB-DSLR target domain — YOLOv8 static threshold (conf=0.25, seed=42)
...
OUTPUT="experiments/yolov8_st_dslr_static_42"
LOG="experiments/run_yolov8_dslr_static.log"
...
echo "=== YOLOv8 PCB-DSLR — static self-training ===" | tee "$LOG"
