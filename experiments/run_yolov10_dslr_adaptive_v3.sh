#!/usr/bin/env bash
# PCB-DSLR target domain (v3) — yolov10 adaptive (adaptive precision-target on DEV), Gen0->Gen3
...
OUTPUT="experiments/yolov10_st_dslr_adaptive_v3_42"
LOG="experiments/run_yolov10_dslr_adaptive_v3.log"
...
echo "=== yolov10 PCB-DSLR adaptive self-training (v3) ===" | tee "$LOG"
