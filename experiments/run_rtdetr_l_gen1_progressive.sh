#!/usr/bin/env bash
# Gen 1 self-training: RT-DETR-l — progressive threshold (0.25 → 0.40 → 0.55, seed=42)
set -euo pipefail

MODEL="rtdetr_l"
CONFIG="configs/rtdetr_l/self_train_progressive.yaml"
OUTPUT="experiments/rtdetr_l_st_progressive_42"
LOG="experiments/run_rtdetr_l_gen1_progressive.log"

echo "=== RT-DETR-l Gen 1 progressive self-training ===" | tee "$LOG"
