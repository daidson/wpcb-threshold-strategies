#!/usr/bin/env bash
# YOLOv8 noisy GEN0 baseline — corrected hyperparameters (v2)
...
# Checkpoint lands at: runs/yolov8/baseline_noisy_v2/weights/best.pt
set -euo pipefail

MODEL="yolov8"
CONFIG="configs/yolov8/base_noisy.yaml"
LOG="experiments/run_yolov8_noisy_gen0_v2.log"

echo "=== YOLOv8 noisy GEN0 baseline training (v2 — corrected hyperparams) ===" | tee "$LOG"
...
echo "Checkpoint expected at: runs/yolov8/baseline_noisy_v2/weights/best.pt" | tee -a "$LOG"
