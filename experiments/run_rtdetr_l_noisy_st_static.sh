#!/usr/bin/env bash
# Noise experiment — RT-DETR-l static threshold (conf=0.25, seed=42)
...
OUTPUT="experiments/rtdetr_l_st_noisy_static_42"
LOG="experiments/run_rtdetr_l_noisy_st_static.log"
...
echo "=== RT-DETR-l noise experiment — static self-training ===" | tee "$LOG"
