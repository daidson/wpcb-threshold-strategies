#!/usr/bin/env bash
# YOLOv8 noisy static self-training — v2 (corrected Gen0 teacher)
...
OUTPUT="experiments/yolov8_st_noisy_static_v2_42"
LOG="experiments/run_yolov8_noisy_st_static_v2.log"
LABELED_IMAGES="data/FICS_PCB_REMAP_NOISE/images"
LABELED_LABELS="data/FICS_PCB_REMAP_NOISE/labels"

echo "=== YOLOv8 noisy static self-training (v2) ===" | tee "$LOG"
