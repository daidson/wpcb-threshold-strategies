#!/usr/bin/env bash
# Gen 1 self-training: YOLOv8 — progressive threshold (0.25 → 0.40 → 0.55, seed=42)
set -euo pipefail

MODEL="yolov8"
CONFIG="configs/yolov8/self_train_progressive.yaml"
OUTPUT="experiments/yolov8_st_progressive_42"
LOG="experiments/run_yolov8_gen1_progressive.log"

echo "=== YOLOv8 Gen 1 progressive self-training ===" | tee "$LOG"
