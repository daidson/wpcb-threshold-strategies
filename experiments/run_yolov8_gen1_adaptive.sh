#!/usr/bin/env bash
# Gen 1 self-training: YOLOv8 — adaptive threshold (per-class max-F1, seed=42)
set -euo pipefail

MODEL="yolov8"
CONFIG="configs/yolov8/self_train.yaml"
OUTPUT="experiments/yolov8_st_adaptive_42"
LOG="experiments/run_yolov8_gen1_adaptive.log"

echo "=== YOLOv8 Gen 1 adaptive self-training ===" | tee "$LOG"
