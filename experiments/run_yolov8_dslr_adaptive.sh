#!/usr/bin/env bash
# PCB-DSLR target domain — YOLOv8 adaptive threshold (seed=42)
...
OUTPUT="experiments/yolov8_st_dslr_adaptive_42"
LOG="experiments/run_yolov8_dslr_adaptive.log"
...
echo "=== YOLOv8 PCB-DSLR — adaptive self-training ===" | tee "$LOG"
