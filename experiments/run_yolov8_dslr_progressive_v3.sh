#!/usr/bin/env bash
# PCB-DSLR target domain (v3) — yolov8 progressive (progressive 0.25->0.35->0.45), Gen0->Gen3
...
OUTPUT="experiments/yolov8_st_dslr_progressive_v3_42"
LOG="experiments/run_yolov8_dslr_progressive_v3.log"
...
echo "=== yolov8 PCB-DSLR progressive self-training (v3) ===" | tee "$LOG"
