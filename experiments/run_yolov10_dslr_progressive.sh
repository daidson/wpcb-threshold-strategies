#!/usr/bin/env bash
# PCB-DSLR target domain — YOLOv10 progressive threshold (0.25→0.35→0.45→0.55, seed=42)
...
OUTPUT="experiments/yolov10_st_dslr_progressive_42"
LOG="experiments/run_yolov10_dslr_progressive.log"
...
echo "=== YOLOv10 PCB-DSLR — progressive self-training ===" | tee "$LOG"
