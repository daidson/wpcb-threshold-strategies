#!/usr/bin/env bash
# Noise experiment — RT-DETR-x adaptive threshold (per-class max-F1, seed=42)
...
OUTPUT="experiments/rtdetr_x_st_noisy_adaptive_42"
LOG="experiments/run_rtdetr_x_noisy_st_adaptive.log"
...
echo "=== RT-DETR-x noise experiment — adaptive self-training ===" | tee "$LOG"
