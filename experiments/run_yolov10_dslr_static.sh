#!/usr/bin/env bash
# PCB-DSLR target domain — YOLOv10 static threshold (conf=0.25, seed=42)
...
OUTPUT="experiments/yolov10_st_dslr_static_42"
LOG="experiments/run_yolov10_dslr_static.log"
...
echo "=== YOLOv10 PCB-DSLR — static self-training ===" | tee "$LOG"
