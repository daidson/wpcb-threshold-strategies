#!/usr/bin/env bash
# Gen 1 self-training: RT-DETR-x — adaptive threshold (per-class max-F1, seed=42)
set -euo pipefail

MODEL="rtdetr_x"
CONFIG="configs/rtdetr_x/self_train.yaml"
OUTPUT="experiments/rtdetr_x_st_adaptive_42"
LOG="experiments/run_rtdetr_x_gen1_adaptive.log"

echo "=== RT-DETR-x Gen 1 adaptive self-training ===" | tee "$LOG"
