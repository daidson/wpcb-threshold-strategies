#!/usr/bin/env bash
# PCB-DSLR target domain — RT-DETR-l adaptive threshold (seed=42)
...
OUTPUT="experiments/rtdetr_l_st_dslr_adaptive_42"
LOG="experiments/run_rtdetr_l_dslr_adaptive.log"
...
echo "=== RT-DETR-l PCB-DSLR — adaptive self-training ===" | tee "$LOG"
