#!/usr/bin/env bash
# Gen 1 self-training: YOLOv10 — static threshold (conf=0.25, seed=42)
set -euo pipefail

MODEL="yolov10"
CONFIG="configs/yolov10/self_train.yaml"
OUTPUT="experiments/yolov10_st_static_42"
LOG="experiments/run_yolov10_gen1_static.log"

echo "=== YOLOv10 Gen 1 static self-training ===" | tee "$LOG"
