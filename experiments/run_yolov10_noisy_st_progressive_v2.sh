#!/usr/bin/env bash
# YOLOv10 noisy progressive self-training — v2 (corrected Gen0 teacher)
...
OUTPUT="experiments/yolov10_st_noisy_progressive_v2_42"
LOG="experiments/run_yolov10_noisy_st_progressive_v2.log"
LABELED_IMAGES="data/FICS_PCB_REMAP_NOISE/images"
LABELED_LABELS="data/FICS_PCB_REMAP_NOISE/labels"

echo "=== YOLOv10 noisy progressive self-training (v2) ===" | tee "$LOG"
