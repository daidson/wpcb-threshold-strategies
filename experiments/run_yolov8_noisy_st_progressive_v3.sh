#!/usr/bin/env bash
# YOLOv8 noisy progressive self-training — v3 (corrected Gen0 teacher)
...
OUTPUT="experiments/yolov8_st_noisy_progressive_v3_42"
LOG="experiments/run_yolov8_noisy_st_progressive_v3.log"
LABELED_IMAGES="data/FICS_PCB_REMAP_NOISE_TRAIN/images"
LABELED_LABELS="data/FICS_PCB_REMAP_NOISE_TRAIN/labels"

echo "=== YOLOv8 noisy progressive self-training (v3) ===" | tee "$LOG"
