...
OUTPUT="experiments/yolo12_st_noisy_progressive_v3_42"
LOG="experiments/run_yolo12_noisy_st_progressive_v3.log"
LABELED_IMAGES="data/FICS_PCB_REMAP_NOISE_TRAIN/images"
LABELED_LABELS="data/FICS_PCB_REMAP_NOISE_TRAIN/labels"

echo "=== YOLO12m noisy progressive self-training (v3) ===" | tee "$LOG"
