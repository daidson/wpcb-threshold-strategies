#!/usr/bin/env bash
# Noise experiment — YOLOv10 adaptive threshold (per-class max-F1, seed=42)
...
OUTPUT="experiments/yolov10_st_noisy_adaptive_42"
LOG="experiments/run_yolov10_noisy_st_adaptive.log"
...
echo "=== YOLOv10 noise experiment — adaptive self-training ===" | tee "$LOG"
