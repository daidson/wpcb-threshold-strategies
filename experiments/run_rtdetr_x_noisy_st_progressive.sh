#!/usr/bin/env bash
# Noise experiment — RT-DETR-x progressive threshold (0.25 → 0.35 → 0.45 → 0.55, seed=42)
...
MODEL="rtdetr_x"
CONFIG="configs/rtdetr_x/self_train_noisy_progressive.yaml"
OUTPUT="experiments/rtdetr_x_st_noisy_progressive_42"
LOG="experiments/run_rtdetr_x_noisy_st_progressive.log"
...
echo "=== RT-DETR-x noise experiment — progressive self-training ===" | tee "$LOG"
