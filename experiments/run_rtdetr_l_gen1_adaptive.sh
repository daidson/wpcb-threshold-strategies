#!/usr/bin/env bash
# Gen 1 self-training: RT-DETR-l — adaptive threshold (per-class max-F1, seed=42)
set -euo pipefail

MODEL="rtdetr_l"
CONFIG="configs/rtdetr_l/self_train.yaml"
OUTPUT="experiments/rtdetr_l_st_adaptive_42"
LOG="experiments/run_rtdetr_l_gen1_adaptive.log"

echo "=== RT-DETR-l Gen 1 adaptive self-training ===" | tee "$LOG"
