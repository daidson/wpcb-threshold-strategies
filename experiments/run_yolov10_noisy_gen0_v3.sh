#!/usr/bin/env bash
# YOLOv10 noisy GEN0 baseline — corrected hyperparameters (v3)
...
# Checkpoint lands at: runs/yolov10/baseline_noisy_v3/weights/best.pt
set -euo pipefail

MODEL="yolov10"
CONFIG="configs/yolov10/base_noisy.yaml"
LOG="experiments/run_yolov10_noisy_gen0_v3.log"

echo "=== YOLOv10 noisy GEN0 baseline training (v3 — corrected hyperparams) ===" | tee "$LOG"
...
echo "Checkpoint expected at: runs/yolov10/baseline_noisy_v3/weights/best.pt" | tee -a "$LOG"
