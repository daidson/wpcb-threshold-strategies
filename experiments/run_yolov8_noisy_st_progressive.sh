#!/usr/bin/env bash
# Noise experiment — YOLOv8 progressive threshold (0.25 → 0.35 → 0.45 → 0.55, seed=42)
...
OUTPUT="experiments/yolov8_st_noisy_progressive_42"
LOG="experiments/run_yolov8_noisy_st_progressive.log"
...
echo "=== YOLOv8 noise experiment — progressive self-training ===" | tee "$LOG"
