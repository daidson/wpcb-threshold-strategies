#!/usr/bin/env bash
# Gen 1 self-training: RT-DETR-x — static threshold (conf=0.25, seed=42)
set -euo pipefail

MODEL="rtdetr_x"
CONFIG="configs/rtdetr_x/self_train.yaml"
OUTPUT="experiments/rtdetr_x_st_static_42"
LOG="experiments/run_rtdetr_x_gen1_static.log"

echo "=== RT-DETR-x Gen 1 static self-training ===" | tee "$LOG"
